...
id = strawberry.federation.field(external=True, graphql_type=IDType)
lastchange = strawberry.federation.field(external=True, graphql_type=typing.Optional[datetime.datetime])
created = strawberry.federation.field(external=True, graphql_type=typing.Optional[datetime.datetime])
createdby_id = strawberry.federation.field(external=True, graphql_type=typing.Optional[IDType])
changedby_id = strawberry.federation.field(external=True, graphql_type=typing.Optional[IDType])
rbacobject_id = strawberry.federation.field(external=True, graphql_type=typing.Optional[IDType])
createdby = strawberry.federation.field(external=True, graphql_type=typing.Optional["UserGQLModel"])
changedby = strawberry.federation.field(external=True, graphql_type=typing.Optional["UserGQLModel"])
rbacobject = strawberry.federation.field(external=True, graphql_type=typing.Optional["RBACObjectGQLModel"])
